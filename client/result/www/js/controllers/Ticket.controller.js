angular
  ...
  .controller('TicketListController', ['$scope', 'Ticket', function($scope,
    ...
    $scope.showDetail = function(id) {
      myNavigator.pushPage('/tickets/detail.html', { animation : 'slide', recordId: id } );
    };
  }])
  .controller('TicketDetailController', ['$scope', 'Ticket', function($scope,
    ...
    $scope.edit = function() {
      myNavigator.pushPage('/tickets/edit.html', { animation : 'lift', recordId: recordId } );
    };
  ...
  .controller('TicketAddController', ['$scope', 'Ticket', '$rootScope',
      '$state', function($scope, Ticket, $rootScope, $state) {
    $scope.save = function() {
