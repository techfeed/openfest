angular
  ...
  .controller('UserGroupListController', ['$scope', 'UserGroup', function($scope,
    ...
    $scope.showDetail = function(id) {
      myNavigator.pushPage('/userGroups/detail.html', { animation : 'slide', recordId: id } );
    };
  }])
  .controller('UserGroupDetailController', ['$scope', 'UserGroup', function($scope,
    ...
    $scope.edit = function() {
      myNavigator.pushPage('/userGroups/edit.html', { animation : 'lift', recordId: recordId } );
    };
  ...
  .controller('UserGroupAddController', ['$scope', 'UserGroup', '$rootScope',
      '$state', function($scope, UserGroup, $rootScope, $state) {
    $scope.save = function() {
